package com.zhifei.cloud.config.datasource.aspect;

import com.zhifei.cloud.config.datasource.annotation.DynamicDataSource;
...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("@annotation(com.zhifei.cloud.config.datasource.annotation.DynamicDataSource) || @within(com.zhifei.cloud.config.datasource.annotation.DynamicDataSource)")
